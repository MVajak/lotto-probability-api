...
import type {LottoDraw, LottoDrawRepository, LottoDrawResultRepository} from '@lotto/database';
import {
...
import {calculateLotteryTheoreticalProbability} from '../../utils/lottery';
